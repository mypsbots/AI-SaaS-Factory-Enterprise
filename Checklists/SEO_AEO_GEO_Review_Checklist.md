...
# CHECKLIST — SEO AEO GEO Review Checklist
...
Validate readiness for **SEO AEO GEO Review Checklist** and prevent defects from reaching production.

---

## 2. Scope

Applies to: Public web pages.
...
Use before the relevant quality gate for Public web pages.
...
This checklist is the gate for Public web pages. A failed item blocks progression until resolved or formally excepted.
...
- [ ] Pages crawlable and indexable
- [ ] Semantic HTML and metadata present
- [ ] schema.org structured data implemented
- [ ] Core Web Vitals pass
- [ ] Canonical URLs and sitemaps correct
...
Unresolved failures escalate to the SEO/AEO/GEO Specialist, then to engineering leadership. Security/Privacy/Compliance failures may block release outright.
...
- **Checklist ID:** CHK-SEO_AEO_GEO_REVIEW_CHECKLIST
- **Owner:** SEO/AEO/GEO Specialist
- **Category:** Growth
- **Version:** 1.0.0
- **Status:** Active
