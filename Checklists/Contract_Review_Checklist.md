---
id: CHK-CONTRACT_REVIEW_CHECKLIST
...
# CHECKLIST — Contract Review Checklist
...
Validate readiness for **Contract Review Checklist** and prevent defects from reaching production.

---

## 2. Scope

Applies to: Customer and vendor contracts.
...
Use before the relevant quality gate for Customer and vendor contracts.
...
This checklist is the gate for Customer and vendor contracts. A failed item blocks progression until resolved or formally excepted.
...
- [ ] Approved template used or deviations reviewed
- [ ] DPA included where personal data is processed
- [ ] SLAs achievable and agreed with engineering
- [ ] Liability and indemnity terms acceptable
- [ ] Termination and renewal terms clear
- [ ] Security/privacy commitments consistent with product
- [ ] IP and confidentiality terms correct
- [ ] Obligations recorded for tracking
...
Unresolved failures escalate to the Legal Counsel, then to engineering leadership. Security/Privacy/Compliance failures may block release outright.
...
- **Checklist ID:** CHK-CONTRACT_REVIEW_CHECKLIST
- **Owner:** Legal Counsel
- **Category:** Legal
- **Version:** 1.0.0
- **Status:** Active
