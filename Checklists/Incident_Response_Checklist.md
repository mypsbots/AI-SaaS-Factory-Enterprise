---
id: CHK-INCIDENT_RESPONSE_CHECKLIST
...
Validate readiness for **Incident Response Checklist** and prevent defects from reaching production.
...
Use before the relevant quality gate for All incidents.
...
This checklist is the gate for All incidents. A failed item blocks progression until resolved or formally excepted.
...
- [ ] Stakeholders and status updates communicated
- [ ] Mitigation applied and verified
- [ ] Customer impact assessed
- [ ] Timeline captured
- [ ] Postmortem scheduled
- [ ] Remediation actions logged and owned
...
Unresolved failures escalate to the Site Reliability Engineer, then to engineering leadership. Security/Privacy/Compliance failures may block release outright.
...
| --- | --- | --- |
| Site Reliability Engineer | Owner | [ ] |
...
- **Checklist ID:** CHK-INCIDENT_RESPONSE_CHECKLIST
- **Owner:** Site Reliability Engineer
- **Category:** Operations
- **Version:** 1.0.0
- **Status:** Active
