---
id: CHK-PENETRATION_TEST_READINESS_CHECKLIST
...
# CHECKLIST — Penetration Test Readiness Checklist
...
Validate readiness for **Penetration Test Readiness Checklist** and prevent defects from reaching production.

---

## 2. Scope

Applies to: Pre-pentest systems.
...
Use before the relevant quality gate for Pre-pentest systems.
...
This checklist is the gate for Pre-pentest systems. A failed item blocks progression until resolved or formally excepted.
...
- [ ] Scope and rules of engagement agreed
- [ ] Test environment representative of production
- [ ] Known issues triaged beforehand
- [ ] Logging/monitoring enabled for the test
- [ ] Emergency contacts defined
- [ ] Data handling and consent confirmed
- [ ] Remediation SLA agreed
- [ ] Retest plan defined
...
Unresolved failures escalate to the Security Engineer, then to engineering leadership. Security/Privacy/Compliance failures may block release outright.
...
- **Checklist ID:** CHK-PENETRATION_TEST_READINESS_CHECKLIST
- **Owner:** Security Engineer
- **Category:** Security
- **Version:** 1.0.0
- **Status:** Active
