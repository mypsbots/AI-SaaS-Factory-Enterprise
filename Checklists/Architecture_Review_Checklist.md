...
Validate readiness for **Architecture Review Checklist** and prevent defects from reaching production.

---

## 2. Scope

Applies to: Significant designs.
...
Use before the relevant quality gate for Significant designs.
...
This checklist is the gate for Significant designs. A failed item blocks progression until resolved or formally excepted.
...
- [ ] Trade-offs captured in an ADR
- [ ] Scalability and resilience addressed
- [ ] Failure modes and DR considered
...
- **Checklist ID:** CHK-ARCHITECTURE_REVIEW_CHECKLIST
- **Owner:** Enterprise Architect
