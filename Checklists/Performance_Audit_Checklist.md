---
id: CHK-PERFORMANCE_AUDIT_CHECKLIST
...
Validate readiness for **Performance Audit Checklist** and prevent defects from reaching production.

---

## 2. Scope

Applies to: User-facing features.
...
Use before the relevant quality gate for User-facing features.
...
This checklist is the gate for User-facing features. A failed item blocks progression until resolved or formally excepted.
...
- [ ] Load/stress tests executed with realistic data
- [ ] p95/p99 latency within SLO
- [ ] Critical rendering path optimised
- [ ] Caching and compression applied
...
Unresolved failures escalate to the Performance Engineer, then to engineering leadership. Security/Privacy/Compliance failures may block release outright.
...
- **Checklist ID:** CHK-PERFORMANCE_AUDIT_CHECKLIST
- **Owner:** Performance Engineer
