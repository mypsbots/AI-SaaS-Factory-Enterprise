...
# CHECKLIST — Data Privacy Checklist
...
Validate readiness for **Data Privacy Checklist** and prevent defects from reaching production.

---

## 2. Scope

Applies to: Features handling personal data.
...
Use before the relevant quality gate for Features handling personal data.
...
This checklist is the gate for Features handling personal data. A failed item blocks progression until resolved or formally excepted.
...
- **Checklist ID:** CHK-DATA_PRIVACY_CHECKLIST
- **Owner:** Privacy Engineer
- **Category:** Privacy
- **Version:** 1.0.0
- **Status:** Active
