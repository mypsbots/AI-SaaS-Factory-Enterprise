---
id: CHK-OBSERVABILITY_READINESS_CHECKLIST
...
# CHECKLIST — Observability Readiness Checklist
...
Validate readiness for **Observability Readiness Checklist** and prevent defects from reaching production.

---

## 2. Scope

Applies to: New/changed services.
...
Use before the relevant quality gate for New/changed services.
...
This checklist is the gate for New/changed services. A failed item blocks progression until resolved or formally excepted.
...
- [ ] Retention and sampling configured
...
Unresolved failures escalate to the Observability Engineer, then to engineering leadership. Security/Privacy/Compliance failures may block release outright.
...
- **Checklist ID:** CHK-OBSERVABILITY_READINESS_CHECKLIST
- **Owner:** Observability Engineer
- **Category:** Operations
- **Version:** 1.0.0
- **Status:** Active
