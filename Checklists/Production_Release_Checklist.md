---
id: CHK-PRODUCTION_RELEASE_CHECKLIST
...
# CHECKLIST — Production Release Checklist
...
Validate readiness for **Production Release Checklist** and prevent defects from reaching production.
...
Use before the relevant quality gate for All production releases.
...
This checklist is the gate for All production releases. A failed item blocks progression until resolved or formally excepted.
...
Unresolved failures escalate to the Release Manager, then to engineering leadership. Security/Privacy/Compliance failures may block release outright.
...
- **Checklist ID:** CHK-PRODUCTION_RELEASE_CHECKLIST
- **Owner:** Release Manager
- **Category:** Release
- **Version:** 1.0.0
- **Status:** Active
