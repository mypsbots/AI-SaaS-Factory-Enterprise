...
# CHECKLIST — RAG Evaluation Checklist
...
Validate readiness for **RAG Evaluation Checklist** and prevent defects from reaching production.

---

## 2. Scope

Applies to: All RAG pipelines.
...
Use before the relevant quality gate for All RAG pipelines.
...
This checklist is the gate for All RAG pipelines. A failed item blocks progression until resolved or formally excepted.
...
- [ ] Tenant/permission filters enforced on retrieval
- [ ] Context relevance measured
- [ ] Faithfulness/grounding measured (RAGAS)
- [ ] Index freshness within target
...
Unresolved failures escalate to the RAG Engineer, then to engineering leadership. Security/Privacy/Compliance failures may block release outright.
...
- **Checklist ID:** CHK-RAG_EVALUATION_CHECKLIST
- **Owner:** RAG Engineer
- **Category:** AI
- **Version:** 1.0.0
- **Status:** Active
