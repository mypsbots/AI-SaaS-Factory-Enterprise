---
id: CHK-GDPR_READINESS_CHECKLIST
...
# CHECKLIST — GDPR Readiness Checklist
...
Validate readiness for **GDPR Readiness Checklist** and prevent defects from reaching production.
...
Use before the relevant quality gate for EU personal data.
...
This checklist is the gate for EU personal data. A failed item blocks progression until resolved or formally excepted.
...
- [ ] Records of processing (RoPA) maintained
- [ ] Data-subject rights workflows operational
- [ ] Retention and deletion enforced
- [ ] DPIA completed for high-risk processing
- [ ] Processor agreements (DPAs) in place
- [ ] Cross-border transfer safeguards applied
...
Unresolved failures escalate to the Privacy Engineer, then to engineering leadership. Security/Privacy/Compliance failures may block release outright.
...
- **Checklist ID:** CHK-GDPR_READINESS_CHECKLIST
- **Owner:** Privacy Engineer
- **Category:** Privacy
- **Version:** 1.0.0
- **Status:** Active
