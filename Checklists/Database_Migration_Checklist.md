...
Validate readiness for **Database Migration Checklist** and prevent defects from reaching production.

---

## 2. Scope

Applies to: Schema changes.
...
Use before the relevant quality gate for Schema changes.
...
This checklist is the gate for Schema changes. A failed item blocks progression until resolved or formally excepted.
...
- [ ] Migration is expand-then-contract
...
Unresolved failures escalate to the Database Architect, then to engineering leadership. Security/Privacy/Compliance failures may block release outright.
...
- **Checklist ID:** CHK-DATABASE_MIGRATION_CHECKLIST
- **Owner:** Database Architect
