...
Validate readiness for **Security Review Checklist** and prevent defects from reaching production.

---

## 2. Scope

Applies to: All features touching sensitive flows.
...
Use before the relevant quality gate for All features touching sensitive flows.
...
This checklist is the gate for All features touching sensitive flows. A failed item blocks progression until resolved or formally excepted.
...
- **Checklist ID:** CHK-SECURITY_REVIEW_CHECKLIST
- **Owner:** Security Engineer
- **Category:** Security
- **Version:** 1.0.0
- **Status:** Active
