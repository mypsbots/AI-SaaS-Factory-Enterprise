...
Validate readiness for **Data Quality Checklist** and prevent defects from reaching production.

---

## 2. Scope

Applies to: Datasets serving analytics/AI.
...
Use before the relevant quality gate for Datasets serving analytics/AI.
...
This checklist is the gate for Datasets serving analytics/AI. A failed item blocks progression until resolved or formally excepted.
...
- [ ] Uniqueness/primary-key integrity verified
- [ ] Validity/format constraints enforced
- [ ] Freshness within target
- [ ] Consistency across sources reconciled
- [ ] Null/outlier thresholds within bounds
- [ ] PII classified and masked where required
...
- **Checklist ID:** CHK-DATA_QUALITY_CHECKLIST
- **Owner:** Data Engineer
- **Category:** Data
- **Version:** 1.0.0
- **Status:** Active
