...
Validate readiness for **Disaster Recovery Checklist** and prevent defects from reaching production.

---

## 2. Scope

Applies to: Critical systems.
...
Use before the relevant quality gate for Critical systems.
...
This checklist is the gate for Critical systems. A failed item blocks progression until resolved or formally excepted.
...
- [ ] Restore tested within RTO
- [ ] Failover procedure documented and drilled
- [ ] Cross-region/redundancy in place
...
Unresolved failures escalate to the Cloud Architect, then to engineering leadership. Security/Privacy/Compliance failures may block release outright.
...
- **Checklist ID:** CHK-DISASTER_RECOVERY_CHECKLIST
- **Owner:** Cloud Architect
- **Category:** Operations
- **Version:** 1.0.0
- **Status:** Active
