...
Validate readiness for **Code Review Checklist** and prevent defects from reaching production.
...
Use before the relevant quality gate for All pull requests.
...
This checklist is the gate for All pull requests. A failed item blocks progression until resolved or formally excepted.
...
- [ ] No obvious security issues (injection, XSS)
...
Unresolved failures escalate to the Principal Engineer, then to engineering leadership. Security/Privacy/Compliance failures may block release outright.
...
- **Checklist ID:** CHK-CODE_REVIEW_CHECKLIST
- **Owner:** Principal Engineer
