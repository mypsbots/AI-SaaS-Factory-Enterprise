---
id: CHK-SALES_POC_READINESS_CHECKLIST
...
# CHECKLIST — Sales POC Readiness Checklist
...
Validate readiness for **Sales POC Readiness Checklist** and prevent defects from reaching production.

---

## 2. Scope

Applies to: Customer proofs of concept.
...
Use before the relevant quality gate for Customer proofs of concept.
...
This checklist is the gate for Customer proofs of concept. A failed item blocks progression until resolved or formally excepted.
...
- [ ] Scope and timeline bounded
- [ ] Required access and data handling agreed
- [ ] Security/privacy questions answered accurately
- [ ] Demoed capabilities exist or are roadmap-committed
- [ ] Environment provisioned with a reset plan
- [ ] Stakeholders and decision process identified
- [ ] Handover-to-Customer-Success plan prepared
...
Unresolved failures escalate to the Sales Engineer, then to engineering leadership. Security/Privacy/Compliance failures may block release outright.
...
- **Checklist ID:** CHK-SALES_POC_READINESS_CHECKLIST
- **Owner:** Sales Engineer
- **Category:** Sales
- **Version:** 1.0.0
- **Status:** Active
