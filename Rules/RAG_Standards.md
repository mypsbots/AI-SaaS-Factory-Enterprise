...
Establish a reusable, enforceable standard for **RAG Standards** across all ASFE SaaS products.

---

## 2. Scope

Applies to: All retrieval pipelines.
...
**Retrieval MUST be access-controlled, grounded, fresh, and evaluated.**
...
Mandatory for All retrieval pipelines. Priority: **High**. Owner: **RAG Engineer**.

---

## 10. Mandatory Requirements (MUST)

- MUST enforce tenant and permission filters on retrieval.
- MUST evaluate context relevance and grounding (RAGAS).
- MUST keep indexes fresh with defined update cadence.
- MUST cite sources for grounded answers.

---

## 11. Recommended Practices (SHOULD)

- SHOULD use hybrid retrieval and re-ranking.
- SHOULD right-size chunks for relevance.

---

## 12. Optional Enhancements (MAY)

- MAY adopt semantic caching.
...
- Global indexes ignoring tenancy.
...
- Request a time-boxed exception from the RAG Engineer with justification and risk assessment.
...
- [ ] Does the change satisfy: Enforce tenant and permission filters on retrieval.
- [ ] Does the change satisfy: Evaluate context relevance and grounding (RAGAS).
- [ ] Does the change satisfy: Keep indexes fresh with defined update cadence.
- [ ] Does the change satisfy: Cite sources for grounded answers.
