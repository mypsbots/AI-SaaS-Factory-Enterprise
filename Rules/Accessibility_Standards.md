---
id: RULE-ACCESSIBILITY_STANDARDS
...
Establish a reusable, enforceable standard for **Accessibility Standards** across all ASFE SaaS products.
...
**User interfaces MUST conform to WCAG 2.2 AA.**
...
Mandatory for All user interfaces. Priority: **High**. Owner: **Accessibility Specialist**.

---

## 10. Mandatory Requirements (MUST)

- MUST provide semantic, keyboard-operable interfaces.
- MUST meet contrast and target-size requirements.
...
- SHOULD include a11y criteria in the definition of done.
- SHOULD publish a conformance statement (VPAT/ACR).

---

## 12. Optional Enhancements (MAY)

- MAY target select WCAG AAA criteria.
...
- Request a time-boxed exception from the Accessibility Specialist with justification and risk assessment.
...
- [ ] Does the change satisfy: Provide semantic, keyboard-operable interfaces.
- [ ] Does the change satisfy: Meet contrast and target-size requirements.
- [ ] Does the change satisfy: Provide text alternatives for non-text content.
- [ ] Does the change satisfy: Test with assistive technologies.
...
- **Rule ID:** RULE-ACCESSIBILITY_STANDARDS
- **Owner:** Accessibility Specialist
- **Category:** Quality
- **Version:** 1.0.0
- **Status:** Active
