---
id: RULE-GIT_AND_VERSION_CONTROL
...
Establish a reusable, enforceable standard for **Git And Version Control** across all ASFE SaaS products.
...
**Source control MUST use protected branches, reviews, and conventional history.**
...
Mandatory for All repositories. Priority: **Medium**. Owner: **Engineering Manager**.

---

## 10. Mandatory Requirements (MUST)

- MUST require pull-request review before merge to main.
- MUST protect main with passing CI and no force-push.
- MUST use Conventional Commits.
- MUST never commit secrets; scan history.

---

## 11. Recommended Practices (SHOULD)

- SHOULD keep PRs small and focused.
- SHOULD sign commits and tags.

---

## 12. Optional Enhancements (MAY)

- MAY adopt trunk-based development.
...
- Request a time-boxed exception from the Engineering Manager with justification and risk assessment.
...
- [ ] Does the change satisfy: Require pull-request review before merge to main.
- [ ] Does the change satisfy: Protect main with passing CI and no force-push.
- [ ] Does the change satisfy: Use Conventional Commits.
- [ ] Does the change satisfy: Never commit secrets; scan history.
...
- **Rule ID:** RULE-GIT_AND_VERSION_CONTROL
- **Owner:** Engineering Manager
