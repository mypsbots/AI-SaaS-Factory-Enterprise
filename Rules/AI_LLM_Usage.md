...
Applies to: All AI/LLM features.
...
**AI/LLM features MUST be safe, evaluated, observable, and cost-controlled.**
...
Mandatory for All AI/LLM features. Priority: **Critical**. Owner: **AI Engineering Director**.

---

## 10. Mandatory Requirements (MUST)

- MUST constrain and validate model outputs before use.
- MUST apply input/output guardrails against injection and abuse.
- MUST gate prompt/model changes on automated evaluation.
- MUST never send secrets/PII to models without controls.

---

## 11. Recommended Practices (SHOULD)

- SHOULD add fallbacks, timeouts, and routing for model calls.
- SHOULD instrument quality, latency, and cost telemetry.

---

## 12. Optional Enhancements (MAY)

- MAY use a model gateway for routing and governance.
...
- Trusting raw model output as executable.
...
- Request a time-boxed exception from the AI Engineering Director with justification and risk assessment.
...
- [ ] Does the change satisfy: Constrain and validate model outputs before use.
- [ ] Does the change satisfy: Apply input/output guardrails against injection and abuse.
- [ ] Does the change satisfy: Gate prompt/model changes on automated evaluation.
- [ ] Does the change satisfy: Never send secrets/PII to models without controls.
