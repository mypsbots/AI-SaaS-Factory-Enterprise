...
Establish a reusable, enforceable standard for **CI CD Standards** across all ASFE SaaS products.
...
**Delivery MUST be automated, gated, and reproducible.**
...
Mandatory for All pipelines. Priority: **High**. Owner: **DevOps Engineer**.

---

## 10. Mandatory Requirements (MUST)

- MUST build once and promote the same artifact.
- MUST gate releases on tests, scans, and policy.
- MUST automate rollback and post-deploy verification.
- MUST store no secrets in pipeline config.

---

## 11. Recommended Practices (SHOULD)

- SHOULD use progressive delivery (canary/blue-green).
- SHOULD generate SBOMs and sign artifacts.

---

## 12. Optional Enhancements (MAY)

- MAY adopt GitOps for deployments.
...
- Request a time-boxed exception from the DevOps Engineer with justification and risk assessment.
...
- [ ] Does the change satisfy: Build once and promote the same artifact.
- [ ] Does the change satisfy: Gate releases on tests, scans, and policy.
- [ ] Does the change satisfy: Automate rollback and post-deploy verification.
- [ ] Does the change satisfy: Store no secrets in pipeline config.
