---
id: RULE-DATA_PROTECTION_AND_PRIVACY
...
# RULE — Data Protection And Privacy
...
Establish a reusable, enforceable standard for **Data Protection And Privacy** across all ASFE SaaS products.
...
**Personal data MUST be minimised, protected, and processed lawfully.**
...
Mandatory for All personal data. Priority: **Critical**. Owner: **Privacy Engineer**.

---

## 10. Mandatory Requirements (MUST)

- MUST classify and inventory all personal data.
- MUST collect the minimum data necessary with a lawful basis.
- MUST support data-subject rights (access, erasure, portability).
- MUST apply retention limits and secure deletion.

---

## 11. Recommended Practices (SHOULD)

- SHOULD pseudonymise or anonymise where feasible.
- SHOULD run DPIAs for high-risk processing.

---

## 12. Optional Enhancements (MAY)

- MAY offer customer-managed encryption keys.
...
- Request a time-boxed exception from the Privacy Engineer with justification and risk assessment.
...
- [ ] Does the change satisfy: Classify and inventory all personal data.
- [ ] Does the change satisfy: Collect the minimum data necessary with a lawful basis.
- [ ] Does the change satisfy: Support data-subject rights (access, erasure, portability).
- [ ] Does the change satisfy: Apply retention limits and secure deletion.
...
- **Rule ID:** RULE-DATA_PROTECTION_AND_PRIVACY
- **Owner:** Privacy Engineer
- **Category:** Privacy
- **Version:** 1.0.0
- **Status:** Active
