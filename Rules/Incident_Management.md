...
Establish a reusable, enforceable standard for **Incident Management** across all ASFE SaaS products.
...
**Incidents MUST be managed with clear command, communication, and learning.**
...
Mandatory for All production incidents. Priority: **Critical**. Owner: **Site Reliability Engineer**.

---

## 10. Mandatory Requirements (MUST)

- MUST declare incidents with defined severity and roles.
- MUST maintain communication during incidents.
- MUST conduct blameless postmortems with actions.
- MUST track and close remediation actions.

---

## 11. Recommended Practices (SHOULD)

- SHOULD maintain runbooks for common incidents.
- SHOULD practise incident drills.

---

## 12. Optional Enhancements (MAY)

- MAY automate incident tooling and paging.
...
- Request a time-boxed exception from the Site Reliability Engineer with justification and risk assessment.
...
- [ ] Does the change satisfy: Declare incidents with defined severity and roles.
- [ ] Does the change satisfy: Maintain communication during incidents.
- [ ] Does the change satisfy: Conduct blameless postmortems with actions.
- [ ] Does the change satisfy: Track and close remediation actions.
...
- **Rule ID:** RULE-INCIDENT_MANAGEMENT
- **Owner:** Site Reliability Engineer
- **Category:** Operations
- **Version:** 1.0.0
- **Status:** Active
