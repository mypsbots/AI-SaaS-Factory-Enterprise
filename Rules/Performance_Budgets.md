...
Establish a reusable, enforceable standard for **Performance Budgets** across all ASFE SaaS products.
...
**Features MUST meet defined performance budgets and Core Web Vitals.**
...
Mandatory for All user-facing features. Priority: **High**. Owner: **Performance Engineer**.

---

## 10. Mandatory Requirements (MUST)

- MUST define and enforce performance budgets in CI.
- MUST meet Core Web Vitals (LCP, INP, CLS) targets.
- MUST test under realistic load before release.
- MUST track p95/p99 latency against SLOs.

---

## 11. Recommended Practices (SHOULD)

- SHOULD optimise critical rendering path.
- SHOULD cache and compress responses appropriately.

---

## 12. Optional Enhancements (MAY)

- MAY adopt edge rendering/CDN for latency.
...
- Request a time-boxed exception from the Performance Engineer with justification and risk assessment.
...
- [ ] Does the change satisfy: Define and enforce performance budgets in CI.
- [ ] Does the change satisfy: Meet Core Web Vitals (LCP, INP, CLS) targets.
- [ ] Does the change satisfy: Test under realistic load before release.
- [ ] Does the change satisfy: Track p95/p99 latency against SLOs.
...
- **Rule ID:** RULE-PERFORMANCE_BUDGETS
- **Owner:** Performance Engineer
