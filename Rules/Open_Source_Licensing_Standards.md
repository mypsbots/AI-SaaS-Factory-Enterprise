---
id: RULE-OPEN_SOURCE_LICENSING_STANDARDS
...
# RULE — Open Source Licensing Standards
...
Establish a reusable, enforceable standard for **Open Source Licensing Standards** across all SaaS products.

---

## 2. Scope

Applies to: All third-party and open-source software.
...
**Open-source usage MUST comply with licence obligations and be tracked.**
...
Mandatory for All third-party and open-source software. Priority: **High**. Owner: **Legal Counsel**.

---

## 10. Mandatory Requirements (MUST)

- MUST maintain an inventory of dependencies and licences (SBOM).
- MUST prohibit licences incompatible with the distribution model.
- MUST comply with attribution and copyleft obligations.
- MUST review new dependencies for licence risk.

---

## 11. Recommended Practices (SHOULD)

- SHOULD automate licence scanning in CI.
- SHOULD prefer permissively licensed, well-maintained libraries.

---

## 12. Optional Enhancements (MAY)

- MAY maintain an approved-licence allowlist.
...
- Request a time-boxed exception from the Legal Counsel with justification and risk assessment.
...
- [ ] Does the change satisfy: Maintain an inventory of dependencies and licences (SBOM).
- [ ] Does the change satisfy: Prohibit licences incompatible with the distribution model.
- [ ] Does the change satisfy: Comply with attribution and copyleft obligations.
- [ ] Does the change satisfy: Review new dependencies for licence risk.
...
- **Rule ID:** RULE-OPEN_SOURCE_LICENSING_STANDARDS
- **Owner:** Legal Counsel
- **Category:** Legal
- **Version:** 1.0.0
- **Status:** Active
