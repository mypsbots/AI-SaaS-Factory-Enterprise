---
id: RULE-ARCHITECTURE_GOVERNANCE_STANDARDS
...
# RULE — Architecture Governance Standards
...
Establish a reusable, enforceable standard for **Architecture Governance Standards** across all SaaS products.

---

## 2. Scope

Applies to: All significant technical decisions.
...
**Significant architectural decisions MUST be reviewed and recorded.**
...
Mandatory for All significant technical decisions. Priority: **High**. Owner: **Enterprise Architect**.

---

## 10. Mandatory Requirements (MUST)

- MUST record significant decisions as ADRs with context and consequences.
- MUST pass architecture review before significant builds.
- MUST address security, scalability, resilience, and cost in designs.
- MUST align designs to the reference architecture and standards.

---

## 11. Recommended Practices (SHOULD)

- SHOULD define fitness functions for key quality attributes.
- SHOULD track and manage technical debt explicitly.

---

## 12. Optional Enhancements (MAY)

- MAY maintain a technology radar.
...
- Request a time-boxed exception from the Enterprise Architect with justification and risk assessment.
...
- [ ] Does the change satisfy: Record significant decisions as ADRs with context and consequences.
- [ ] Does the change satisfy: Pass architecture review before significant builds.
- [ ] Does the change satisfy: Address security, scalability, resilience, and cost in designs.
- [ ] Does the change satisfy: Align designs to the reference architecture and standards.
...
- **Rule ID:** RULE-ARCHITECTURE_GOVERNANCE_STANDARDS
- **Owner:** Enterprise Architect
