---
id: RULE-DATA_GOVERNANCE_STANDARDS
...
# RULE — Data Governance Standards
...
Establish a reusable, enforceable standard for **Data Governance Standards** across all SaaS products.

---

## 2. Scope

Applies to: All data assets.
...
**Data MUST be classified, governed, and retained according to policy and law.**
...
Mandatory for All data assets. Priority: **High**. Owner: **Data Engineer**.

---

## 10. Mandatory Requirements (MUST)

- MUST classify data by sensitivity and ownership.
- MUST maintain data lineage and a searchable catalogue.
- MUST apply retention and deletion policies.
- MUST restrict access by least privilege and purpose.

---

## 11. Recommended Practices (SHOULD)

- SHOULD mask or tokenise sensitive fields outside production.
- SHOULD audit data access regularly.

---

## 12. Optional Enhancements (MAY)

- MAY adopt automated data-governance tooling.
...
- Untracked, unclassified data sprawl.
...
- [ ] Does the change satisfy: Classify data by sensitivity and ownership.
- [ ] Does the change satisfy: Maintain data lineage and a searchable catalogue.
- [ ] Does the change satisfy: Apply retention and deletion policies.
- [ ] Does the change satisfy: Restrict access by least privilege and purpose.
...
- **Rule ID:** RULE-DATA_GOVERNANCE_STANDARDS
- **Owner:** Data Engineer
- **Category:** Data
- **Version:** 1.0.0
- **Status:** Active
