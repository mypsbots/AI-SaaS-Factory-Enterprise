...
**Databases MUST ensure integrity, recoverability, and safe evolution.**
...
Mandatory for All databases. Priority: **High**. Owner: **Database Architect**.

---

## 10. Mandatory Requirements (MUST)

- MUST use reversible, expand-then-contract migrations.
- MUST encrypt data at rest; restrict access by role.
- MUST maintain tested backups with defined RPO/RTO.
- MUST use parameterised queries only.

---

## 11. Recommended Practices (SHOULD)

- SHOULD index for actual query patterns.
- SHOULD partition and archive large datasets.

---

## 12. Optional Enhancements (MAY)

- MAY adopt read replicas for scaling.
...
- Request a time-boxed exception from the Database Architect with justification and risk assessment.
...
- [ ] Does the change satisfy: Use reversible, expand-then-contract migrations.
- [ ] Does the change satisfy: Encrypt data at rest; restrict access by role.
- [ ] Does the change satisfy: Maintain tested backups with defined RPO/RTO.
- [ ] Does the change satisfy: Use parameterised queries only.
...
- **Rule ID:** RULE-DATABASE_STANDARDS
- **Owner:** Database Architect
