---
id: RULE-PRE_SALES_ENGINEERING_STANDARDS
...
# RULE — Pre Sales Engineering Standards
...
Establish a reusable, enforceable standard for **Pre Sales Engineering Standards** across all SaaS products.

---

## 2. Scope

Applies to: All technical pre-sales activities.
...
**Pre-sales activities MUST set accurate expectations and protect security and privacy commitments.**
...
Mandatory for All technical pre-sales activities. Priority: **Medium**. Owner: **Sales Engineer**.

---

## 10. Mandatory Requirements (MUST)

- MUST scope proofs of concept with clear, time-boxed success criteria.
- MUST represent only capabilities that exist or are roadmap-committed.
- MUST involve Security/Privacy for questionnaire and RFP answers.
- MUST hand over full context to Customer Success on win.

---

## 11. Recommended Practices (SHOULD)

- SHOULD use standardised demo environments and scripts.
- SHOULD capture field feedback for product.

---

## 12. Optional Enhancements (MAY)

- MAY automate security-questionnaire responses from a knowledge base.
...
- Request a time-boxed exception from the Sales Engineer with justification and risk assessment.
...
- [ ] Does the change satisfy: Scope proofs of concept with clear, time-boxed success criteria.
- [ ] Does the change satisfy: Represent only capabilities that exist or are roadmap-committed.
- [ ] Does the change satisfy: Involve Security/Privacy for questionnaire and RFP answers.
- [ ] Does the change satisfy: Hand over full context to Customer Success on win.
...
- **Rule ID:** RULE-PRE_SALES_ENGINEERING_STANDARDS
- **Owner:** Sales Engineer
- **Category:** Sales
- **Version:** 1.0.0
- **Status:** Active
