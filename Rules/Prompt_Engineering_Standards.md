---
id: RULE-PROMPT_ENGINEERING_STANDARDS
...
# RULE — Prompt Engineering Standards
...
Establish a reusable, enforceable standard for **Prompt Engineering Standards** across all ASFE SaaS products.
...
**Prompts MUST be versioned, evaluated, and resistant to injection.**
...
Mandatory for All prompts. Priority: **High**. Owner: **Prompt Engineer**.

---

## 10. Mandatory Requirements (MUST)

- MUST version prompts; never edit in place silently.
- MUST separate system/developer/user instructions.
- MUST evaluate prompt changes before release.
- MUST quarantine and label untrusted content.

---

## 11. Recommended Practices (SHOULD)

- SHOULD demand structured output and validate it.
- SHOULD maintain few-shot exemplars.

---

## 12. Optional Enhancements (MAY)

- MAY use templating with strict variable boundaries.
...
- Request a time-boxed exception from the Prompt Engineer with justification and risk assessment.
...
- [ ] Does the change satisfy: Version prompts; never edit in place silently.
- [ ] Does the change satisfy: Separate system/developer/user instructions.
- [ ] Does the change satisfy: Evaluate prompt changes before release.
- [ ] Does the change satisfy: Quarantine and label untrusted content.
...
- **Rule ID:** RULE-PROMPT_ENGINEERING_STANDARDS
- **Owner:** Prompt Engineer
- **Category:** AI
- **Version:** 1.0.0
- **Status:** Active
