---
id: RULE-INFRASTRUCTURE_AS_CODE
...
Establish a reusable, enforceable standard for **Infrastructure As Code** across all ASFE SaaS products.
...
**Infrastructure MUST be declarative, reviewed, and reproducible.**
...
Mandatory for All infrastructure. Priority: **High**. Owner: **Cloud Architect**.

---

## 10. Mandatory Requirements (MUST)

- MUST define all infrastructure as version-controlled code.
- MUST review IaC changes like application code.
- MUST apply policy-as-code guardrails.
- MUST prohibit manual click-ops in production.

---

## 11. Recommended Practices (SHOULD)

- SHOULD use immutable, reproducible builds.
- SHOULD detect and remediate drift automatically.

---

## 12. Optional Enhancements (MAY)

- MAY adopt reusable module registries.
...
- Request a time-boxed exception from the Cloud Architect with justification and risk assessment.
...
- [ ] Does the change satisfy: Define all infrastructure as version-controlled code.
- [ ] Does the change satisfy: Review IaC changes like application code.
- [ ] Does the change satisfy: Apply policy-as-code guardrails.
- [ ] Does the change satisfy: Prohibit manual click-ops in production.
...
- **Rule ID:** RULE-INFRASTRUCTURE_AS_CODE
- **Owner:** Cloud Architect
- **Category:** Cloud
- **Version:** 1.0.0
- **Status:** Active
