---
id: RULE-DOCUMENT_LIFECYCLE_GOVERNANCE
...
# RULE — Document Lifecycle Governance
...
Establish a reusable, enforceable standard for **Document Lifecycle Governance** across all SaaS products.
...
**Framework documents MUST follow a defined lifecycle: versioned, reviewed, and deliberately deprecated.**
...
Mandatory for All framework documents. Priority: **Medium**. Owner: **Enterprise Architect**.

---

## 10. Mandatory Requirements (MUST)

- MUST use semantic versioning for documents.
- MUST assign each document an owner and review frequency.
- MUST review documents on the defined cadence.
- MUST mark superseded documents as deprecated with a successor.

---

## 11. Recommended Practices (SHOULD)

- SHOULD keep a version history per document.
- SHOULD validate documents against the specification before publishing.

---

## 12. Optional Enhancements (MAY)

- MAY automate document validation in CI.
...
- Stale documents past their review date.
...
- [ ] Does the change satisfy: Use semantic versioning for documents.
- [ ] Does the change satisfy: Assign each document an owner and review frequency.
- [ ] Does the change satisfy: Review documents on the defined cadence.
- [ ] Does the change satisfy: Mark superseded documents as deprecated with a successor.
...
- **Rule ID:** RULE-DOCUMENT_LIFECYCLE_GOVERNANCE
- **Owner:** Enterprise Architect
- **Category:** Governance
- **Version:** 1.0.0
- **Status:** Active
