---
id: RULE-DATA_ENGINEERING_STANDARDS
...
# RULE — Data Engineering Standards
...
Establish a reusable, enforceable standard for **Data Engineering Standards** across all SaaS products.

---

## 2. Scope

Applies to: All data pipelines and datasets.
...
**Data pipelines MUST be reliable, tested, observable, and reproducible.**
...
Mandatory for All data pipelines and datasets. Priority: **High**. Owner: **Data Engineer**.

---

## 10. Mandatory Requirements (MUST)

- MUST make pipelines idempotent and safe to replay.
- MUST validate data quality with automated tests at boundaries.
- MUST instrument pipelines with logging, metrics, and lineage.
- MUST version pipeline code and evolve schemas backward-compatibly.

---

## 11. Recommended Practices (SHOULD)

- SHOULD treat datasets as products with owners and SLAs.
- SHOULD document datasets in a data dictionary.

---

## 12. Optional Enhancements (MAY)

- MAY adopt a lakehouse / medallion architecture.
...
- Request a time-boxed exception from the Data Engineer with justification and risk assessment.
...
- [ ] Does the change satisfy: Make pipelines idempotent and safe to replay.
- [ ] Does the change satisfy: Validate data quality with automated tests at boundaries.
- [ ] Does the change satisfy: Instrument pipelines with logging, metrics, and lineage.
- [ ] Does the change satisfy: Version pipeline code and evolve schemas backward-compatibly.
...
- **Rule ID:** RULE-DATA_ENGINEERING_STANDARDS
- **Owner:** Data Engineer
