...
Establish a reusable, enforceable standard for **Dependency Management** across all ASFE SaaS products.
...
**Dependencies MUST be tracked, scanned, pinned, and kept current.**
...
Mandatory for All dependencies. Priority: **High**. Owner: **DevSecOps Engineer**.

---

## 10. Mandatory Requirements (MUST)

- MUST pin and lock dependency versions.
- MUST scan dependencies for vulnerabilities (SCA).
- MUST maintain an SBOM.
- MUST remediate critical vulnerabilities within SLA.

---

## 11. Recommended Practices (SHOULD)

- SHOULD automate dependency updates with tests.
- SHOULD prefer well-maintained, vetted libraries.

---

## 12. Optional Enhancements (MAY)

- MAY use private registries with provenance.
...
- Request a time-boxed exception from the DevSecOps Engineer with justification and risk assessment.
...
- [ ] Does the change satisfy: Pin and lock dependency versions.
- [ ] Does the change satisfy: Scan dependencies for vulnerabilities (SCA).
- [ ] Does the change satisfy: Maintain an SBOM.
- [ ] Does the change satisfy: Remediate critical vulnerabilities within SLA.
...
- **Rule ID:** RULE-DEPENDENCY_MANAGEMENT
- **Owner:** DevSecOps Engineer
- **Category:** Security
- **Version:** 1.0.0
- **Status:** Active
