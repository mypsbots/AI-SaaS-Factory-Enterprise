---
id: RULE-DOCUMENTATION_STANDARDS
...
Establish a reusable, enforceable standard for **Documentation Standards** across all ASFE SaaS products.
...
**Documentation MUST be accurate, versioned, accessible, and docs-as-code.**
...
Mandatory for All documentation. Priority: **Medium**. Owner: **Technical Writer**.

---

## 10. Mandatory Requirements (MUST)

- MUST version docs with the product.
- MUST generate API docs from contracts.
- MUST keep docs accurate and current at release.
- MUST meet accessibility and readability standards.

---

## 11. Recommended Practices (SHOULD)

- SHOULD provide task-focused, testable instructions.
- SHOULD include examples and quickstarts.

---

## 12. Optional Enhancements (MAY)

- MAY localise documentation.
...
- Request a time-boxed exception from the Technical Writer with justification and risk assessment.
...
- [ ] Does the change satisfy: Version docs with the product.
- [ ] Does the change satisfy: Generate API docs from contracts.
- [ ] Does the change satisfy: Keep docs accurate and current at release.
- [ ] Does the change satisfy: Meet accessibility and readability standards.
...
- **Rule ID:** RULE-DOCUMENTATION_STANDARDS
- **Owner:** Technical Writer
