...
Establish a reusable, enforceable standard for **Contracting Standards** across all SaaS products.

---

## 2. Scope

Applies to: All customer and vendor contracts.
...
**Contracts MUST use approved templates and protect the business and its customers.**
...
Mandatory for All customer and vendor contracts. Priority: **High**. Owner: **Legal Counsel**.

---

## 10. Mandatory Requirements (MUST)

- MUST use approved contract templates and fallback positions.
- MUST include a Data Processing Agreement where personal data is processed.
- MUST define clear SLAs, liability, and termination terms.
- MUST obtain legal review before signing non-standard terms.

---

## 11. Recommended Practices (SHOULD)

- SHOULD track obligations and renewal dates.
- SHOULD align contracts with security and privacy commitments.

---

## 12. Optional Enhancements (MAY)

- MAY use contract lifecycle management tooling.
...
- [ ] Does the change satisfy: Use approved contract templates and fallback positions.
- [ ] Does the change satisfy: Include a Data Processing Agreement where personal data is processed.
- [ ] Does the change satisfy: Define clear SLAs, liability, and termination terms.
- [ ] Does the change satisfy: Obtain legal review before signing non-standard terms.
...
- **Rule ID:** RULE-CONTRACTING_STANDARDS
- **Owner:** Legal Counsel
- **Category:** Legal
- **Version:** 1.0.0
- **Status:** Active
