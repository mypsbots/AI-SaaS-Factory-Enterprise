...
Establish a reusable, enforceable standard for **Testing Standards** across all ASFE SaaS products.
...
**Changes MUST be protected by automated, deterministic tests across the test pyramid.**
...
Mandatory for All code. Priority: **High**. Owner: **QA Lead**.

---

## 10. Mandatory Requirements (MUST)

- MUST cover new/changed behaviour with tests.
- MUST keep tests deterministic and isolated.
- MUST run tests in CI as a merge gate.
- MUST maintain meaningful coverage of critical paths.

---

## 11. Recommended Practices (SHOULD)

- SHOULD favour fast unit tests; reserve E2E for journeys.
- SHOULD quarantine and fix flaky tests promptly.

---

## 12. Optional Enhancements (MAY)

- MAY adopt mutation testing for critical modules.
...
- Request a time-boxed exception from the QA Lead with justification and risk assessment.
...
- [ ] Does the change satisfy: Cover new/changed behaviour with tests.
- [ ] Does the change satisfy: Keep tests deterministic and isolated.
- [ ] Does the change satisfy: Run tests in CI as a merge gate.
- [ ] Does the change satisfy: Maintain meaningful coverage of critical paths.
...
- **Rule ID:** RULE-TESTING_STANDARDS
- **Owner:** QA Lead
- **Category:** Quality
- **Version:** 1.0.0
- **Status:** Active
